...
public class Main implements ModInitializer {
	...
	public static final GameType<ClutchPracticeConfig> CLUTCH_PRACTICE_TYPE = GameType.register(CLUTCH_PRACTICE_ID, ClutchPracticeGame::open, ClutchPracticeConfig.CODEC);
